...
print("IS_PYPY:" + str(IS_PYPY))
print("IS_JYTHON:" + str(IS_JYTHON))
if IS_JYTHON:
    ...
    if IS_WIN:
        ...
        print("Python version: " + "python{}.{}".format(*sys.version_info))
        #site_packages = os.path.join(base, "lib", "python{}.{}".format(*sys.version_info), "site-packages")
        site_packages = os.path.join(base, "lib64","python3.8", "site-packages")
prev = set(sys.path)
